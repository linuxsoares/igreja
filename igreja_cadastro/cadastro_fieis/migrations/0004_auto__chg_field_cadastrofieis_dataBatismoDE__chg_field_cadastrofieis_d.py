...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataBatismoDE', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CadastroFieis.dataSaida'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataSaida', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CadastroFieis.dataConversaoDE'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataConversaoDE', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CadastroFieis.dataCasamento'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataCasamento', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'CadastroFieis.dataBatismoDE'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataBatismoDE', self.gf('django.db.models.fields.DateField')(max_length=10, null=True))

        # Changing field 'CadastroFieis.dataSaida'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataSaida', self.gf('django.db.models.fields.DateField')(max_length=10, null=True))

        # Changing field 'CadastroFieis.dataConversaoDE'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataConversaoDE', self.gf('django.db.models.fields.DateField')(max_length=10, null=True))

        # Changing field 'CadastroFieis.dataCasamento'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'dataCasamento', self.gf('django.db.models.fields.DateField')(max_length=10, null=True))
