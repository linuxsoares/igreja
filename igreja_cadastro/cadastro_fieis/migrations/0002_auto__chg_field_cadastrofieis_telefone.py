...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CadastroFieis.telefone'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'telefone', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'CadastroFieis.telefone'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'telefone', self.gf('django.db.models.fields.CharField')(max_length=10))
