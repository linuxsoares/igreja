...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CadastroFieis.recebidoCartaDataDE'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'recebidoCartaDataDE', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'CadastroFieis.recebidoCartaDataDE'
        db.alter_column(u'cadastro_fieis_cadastrofieis', 'recebidoCartaDataDE', self.gf('django.db.models.fields.DateField')(default=0, max_length=10))
