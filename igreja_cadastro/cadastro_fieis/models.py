...
class CadastroFieis(models.Model):
    ...
    dataCasamento = models.DateField(_('data de casamento'), max_length=10, blank=True, null=True, default=None)
    conjuge = models.CharField(_('conjuge'), max_length=200, blank=True)
    crente = models.CharField(choices=CRENTE, max_length=3)
    dataConversaoDE = models.DateField(_('data conversao'), max_length=10, blank=True, null=True, default=None)
    ...
    dataBatismoDE = models.DateField(_('data de batismo'), max_length=10, blank=True, null=True, default=None)
    ...
    recebidoCartaDataDE = models.DateField(_('recebido com carta? data:'), max_length=10, blank=True, default=None)
    igrejaOrigemDE = models.CharField(_('igreja de origem'), max_length=255, blank=True)
    dataSaida = models.DateField(_('data de saida:'), max_length=10, blank=True, null=True, default=None)
