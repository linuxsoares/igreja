...
class CadastroFieis(models.Model):
    ...
    dataConversaoDE = models.DateField(_('data conversao'), blank=True, null=True)
    ...
    dataBatismoDE = models.DateField(_('data de batismo'), blank=True, null=True)
    ...
    recebidoCartaDataDE = models.DateField(_('recebido com carta? data:'), null=True, blank=True)
    igrejaOrigemDE = models.CharField(_('igreja de origem'), max_length=255, blank=True)
    dataSaida = models.DateField(_('data de saida:'), blank=True, null=True)
    ...
    foto_fiel = models.ImageField(_('foto'), upload_to='images/', null=True, blank=True)
